...
function HeroCtaCard() {
  return (
    <div className="w-full max-w-[1240px] rounded-2xl bg-surface-card p-5 shadow-card-hover ring-1 ring-divider sm:p-7 md:p-8">
...
export function Hero() {
  return (
    <section className="relative w-full overflow-visible sm:overflow-hidden">
      ...
      <div className="relative mx-auto flex min-h-[min(70vh,640px)] max-w-[1280px] min-w-0 flex-col px-4 pb-6 pt-12 sm:min-h-[min(76vh,760px)] sm:pb-36 sm:pt-16 lg:px-8">
        ...
        <div className="relative z-10 mt-[26px] flex w-full justify-center sm:absolute sm:bottom-0 sm:left-0 sm:right-0 sm:mt-0 sm:px-6 lg:px-8">
          <div className="pointer-events-auto w-full max-w-[1240px] translate-y-0 sm:translate-y-1/3">
            <HeroCtaCard />
          </div>
        </div>
      </div>

      <div className="h-16 bg-canvas sm:h-24" aria-hidden />
    </section>
  );
}
